/**
 * Created by zacw on 10/7/16.
 */
/**
 * @license Highcharts JS vmaster (2016-10-07)
 *
...
H.defaultOptions = {
	...
	global: {
		...
		VMLRadialGradientURL: 'http://code.highcharts.com@product.cdnpath@/master/gfx/vml-radial-gradient.png'
...
H.Series.prototype.drawBreaks = function (axis, keys) {
	...
	each(keys, function (key) {
		...
		threshold = axis && axis.isXAxis ? axis.min : pick(series.options.threshold, axis.min);
		each(points, function (point) {
